...
8. Use `query_knowledge_base` whenever you encounter software, a process name, a user, or a file path you are not certain about. The knowledge base contains exercise-specific documentation that can definitively classify artifacts as authorized or suspicious — this is cheaper than a false positive.
